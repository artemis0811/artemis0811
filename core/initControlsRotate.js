...
function initControlsRotate(canvas) {
    ...
    canvas.on('after:render', () => {
        ...
        if (activeObject) {
            // Ensure angle is a number before proceeding
            const angle = typeof activeObject.angle === 'number' ? activeObject.angle : 0;

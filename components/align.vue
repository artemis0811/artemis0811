<template>
    <div class="align">
        ...
        <b-button v-b-tooltip.hover title="left" @click="left" variant="outline-secondary"
            :style="positionX == 'left' ? 'background-color:#d5d5d5' : ''" size="sm">
        ...
        <b-button v-b-tooltip.hover title="centerX" @click="xcenter" variant="outline-secondary"
            :style="positionX == 'xCenter' ? 'background-color:#d5d5d5' : ''" size="sm">
        ...
        <b-button v-b-tooltip.hover title="right" @click="right" variant="outline-secondary"
            :style="positionX == 'right' ? 'background-color:#d5d5d5' : ''" size="sm">
        ...
        <b-button v-b-tooltip.hover title="top" @click="top" variant="outline-secondary"
            :style="positionY == 'top' ? 'background-color:#d5d5d5' : ''" size="sm">
        ...
        <b-button v-b-tooltip.hover title="centerY" @click="ycenter" variant="outline-secondary"
            :style="positionY == 'yCenter' ? 'background-color:#d5d5d5' : ''" size="sm">
        ...
        <b-button v-b-tooltip.hover title="bottom" @click="bottom" variant="outline-secondary"
            :style="positionY == 'bottom' ? 'background-color:#d5d5d5' : ''" size="sm">
...
export default {
    ...
    methods: {
        ...
        left() {
            ...
            if (
                activeObject &&
                activeObject._objects[1].width != activeObject.width
            ) {
                ...
                activeObject.set("position", {
                    positionX: "left",
                    positionY: activeObject
                        ? activeObject.position.positionY
            ...
            if (
                ...
                activeSelection.forEachObject((item) => {
                    if (item.type == "i-text") {
                        item.set({
                            left:
                                activeObjectLeft - item.width * item.scaleX - this.strokeWidth,
                        });
                        item.setCoords();
                        this.canvas.c.renderAll();
                    }
        ...
        ycenter() {
            ...
            activeObject.set("position", {
                positionY: "yCenter",
                positionX: activeObject
                    ? activeObject.position.positionX
            ...
            if (activeObject) {
                ...
                activeSelection.forEachObject((item) => {
                    if (item.type == "i-text") {
                        item.set({
                            top:
                                activeObjectTop - item.height * item.scaleY - this.strokeWidth,
                        });
                        item.setCoords();
                        this.canvas.c.renderAll();
                    }

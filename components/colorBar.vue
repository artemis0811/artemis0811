<template>
    <div v-if="!mSelectMode">
        <b-col>
            <b-button variant="outline-secondary" size="sm" @click="set_bg">{{ bg_set_title }}</b-button>
        </b-col>
        <b-col>
            <b-form-input v-if="showColor" type="color" v-model="color" @change="setThisColor" size="sm"></b-form-input>
        </b-col>
...
import { transParent } from '@editor/utils/imgConstant';
export default {
    name: 'bgBar',

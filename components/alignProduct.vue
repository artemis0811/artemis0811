<template>
    <div class="align-product ">
        ...
        <b-button variant="outline-secondary" v-b-tooltip.hover title="left" @click="left" :style="positionX == 'left' ? 'background-color:#d5d5d5' : ''" size="sm">
        ...
        <b-button variant="outline-secondary" v-b-tooltip.hover title="centerX" @click="xcenter" :style="positionX == 'xCenter' ? 'background-color:#d5d5d5' : ''" size="sm">
        ...
        <b-button variant="outline-secondary" v-b-tooltip.hover title="right" @click="right" :style="positionX == 'right' ? 'background-color:#d5d5d5' : ''" size="sm">
        ...
        <!-- vertical alignment -->
        <b-button variant="outline-secondary" v-b-tooltip.hover title="top" @click="top" :style="positionY == 'top' ? 'background-color:#d5d5d5' : ''" size="sm">
        ...
        <b-button variant="outline-secondary" v-b-tooltip.hover title="centerY" @click="ycenter" :style="positionY == 'yCenter' ? 'background-color:#d5d5d5' : ''" size="sm">
        ...
        <b-button variant="outline-secondary" v-b-tooltip.hover title="bottom" @click="bottom" :style="positionY == 'bottom' ? 'background-color:#d5d5d5' : ''" size="sm">
